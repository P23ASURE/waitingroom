...
#include "src/CompressorDSP1.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct CompressorDSP1MetaData {
		SN_NODE_ID("CompressorDSP1");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using CompressorDSP1 = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _CompressorDSP1, CompressorDSP1MetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
