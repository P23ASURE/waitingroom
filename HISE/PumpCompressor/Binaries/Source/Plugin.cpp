...
String hise::FrontendHandler::getProjectName() { return "PumpComp"; };
String hise::FrontendHandler::getCompanyName() { return "23DSP"; };
String hise::FrontendHandler::getCompanyWebsiteName() { return "http://yourcompany.com"; };
String hise::FrontendHandler::getCompanyCopyright() { return "(c)2017, Company"; };
String hise::FrontendHandler::getVersionString() { return "0.9.0"; };
